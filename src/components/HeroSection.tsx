...
const highlights = [
  ...
  { icon: Hash, label: "Varias chances", value: "Voce define a quantidade" },
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
            Cada compra aprovada libera o conteudo em PDF e tambem garante numeros da sorte para voce concorrer.
            O resultado sera apurado com base no primeiro premio da Loteria Federal.
          </p>
