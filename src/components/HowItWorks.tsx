...
const steps = [
  {
    description: "Escolha a campanha ativa, conclua o pagamento e aguarde a confirmacao.",
    icon: FileCheck2,
    title: "1. Compre o poster",
  },
  {
    description: "Pagamento aprovado libera o download do PDF e gera automaticamente seus numeros da sorte unicos.",
    icon: Download,
    title: "2. Receba o PDF e os numeros",
  },
  {
    description: "A apuracao usa os 6 digitos completos do primeiro premio da Loteria Federal para definir o numero oficial do sorteio.",
    icon: Landmark,
    title: "3. Acompanhe o sorteio",
  },
];
    ...
    <section className="bg-background py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto max-w-xl text-muted-foreground">Sua sorte comeca aqui.</p>
        </motion.div>
