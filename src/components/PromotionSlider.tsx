    ...
    <section className="bg-secondary/20 py-16">
      <div className="container mx-auto px-4">
        <h2 className="mb-8 text-center text-3xl font-bold font-display">
          <span className="text-gradient-gold">Campanhas</span> e Promocoes
        </h2>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <h3 className="text-xl font-bold font-display">{currentPromotion.title}</h3>
                {currentPromotion.description ? (
                  <p className="mt-1 max-w-2xl text-sm text-muted-foreground">{currentPromotion.description}</p>
                ) : (
                  <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                    Promocao ativa pronta para receber novas entradas.
                  </p>
                )}
              </div>
            </motion.div>
